...
import { Search, MapPin, Clock, Users, ArrowLeft, Filter } from "lucide-react"
...
export default function BrowsePage() {
  ...
  useEffect(() => {
    applyFilters()
  }, [searchTerm, availabilityFilter, skillFilter, profiles])
  ...
  const applyFilters = () => {
    ...
    if (skillFilter !== "all") {
      filtered = filtered.filter((profile) =>
        profile.skills_offered?.some((skill) => skill.toLowerCase().includes(skillFilter.toLowerCase())),
      )
    }
  ...
  const getAllSkills = () => {
    ...
    profiles.forEach((profile) => {
      profile.skills_offered?.forEach((skill) => skills.add(skill))
    })
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Browse Members</h1>
              </div>
            </div>
            {user && (
      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            {(searchTerm || availabilityFilter !== "all" || skillFilter !== "all") && (
              <Button
                variant="outline"
                size="sm"
                onClick={() => {
        ...
        {filteredProfiles.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-4">Try adjusting your search terms or filters to find more members.</p>
            <Button
              onClick={() => {
                setSearchTerm("")
                setAvailabilityFilter("all")
